import { dismissNotice } from '../../common/helpers/auth/concurrent-login.js'
import { statusCodes } from '../../common/constants/status-codes.js'

// Only follow the Referer back if it is same-host — a full URL is expected
// (browsers send an absolute Referer), and anything else falls back to `/`
...
export async function dismissSessionNoticeController(request, h) {
  ...
  return h.redirect(returnTo(request, '/'))
}
