...
/**
 * Verify a Defra ID id_token.
 *
 * Performs full RFC 7519 / OpenID Connect validation:
 *   - signature (against JWKS from discovery document)
 *   - issuer (`iss`) matches the discovery document issuer
 ...
 */
export async function verifyDefraIdToken(
  idToken,
