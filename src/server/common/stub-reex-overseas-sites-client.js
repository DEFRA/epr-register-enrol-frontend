...
// Fake ReEx overseas-sites data keyed by organisationId then by the string key from the
// registration's overseasSites map. Shape mirrors the ReEx endpoint response (§5.2):
// GET v1/organisations/{id}/registrations/{id}/accreditations/{id}/overseas-sites
// { [key]: { name, country, address{line1,townOrCity}, coordinates, validFrom } }
